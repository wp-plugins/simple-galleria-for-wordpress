...
5. That's it
6. If you want to customize the apparence, go to settings > Simple Galleria
...
== Screenshots ==
1. The native gallery shortcode
2. The native WordPress gallery
3. The lightbox with the galleria render
4. The admin option panel
